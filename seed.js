...
export const mockOrders = [
  { status: 'Complete', totalQuantity: 7, totalCost: '$26.44' },
  { status: 'Confirmed', totalQuantity: 6, totalCost: '$72.11' },
  { status: 'Confirmed', totalQuantity: 11, totalCost: '$67.52' },
  { status: 'Confirmed', totalQuantity: 15, totalCost: '$34.38' },
  { status: 'Complete', totalQuantity: 9, totalCost: '$33.83' },
  { status: 'Confirmed', totalQuantity: 10, totalCost: '$110.16' },
  { status: 'Processing', totalQuantity: 6, totalCost: '$87.39' },
  { status: 'Processing', totalQuantity: 7, totalCost: '$105.24' },
  { status: 'Complete', totalQuantity: 8, totalCost: '$99.83' },
  { status: 'Processing', totalQuantity: 1, totalCost: '$14.07' },
  { status: 'Confirmed', totalQuantity: 3, totalCost: '$13.25' },
  { status: 'Complete', totalQuantity: 7, totalCost: '$82.04' },
  { status: 'Complete', totalQuantity: 10, totalCost: '$101.26' },
  { status: 'Confirmed', totalQuantity: 15, totalCost: '$75.91' },
  { status: 'Processing', totalQuantity: 14, totalCost: '$48.55' },
  { status: 'Confirmed', totalQuantity: 9, totalCost: '$54.83' },
  { status: 'Processing', totalQuantity: 1, totalCost: '$118.31' },
  { status: 'Complete', totalQuantity: 1, totalCost: '$43.53' },
  { status: 'Confirmed', totalQuantity: 7, totalCost: '$99.43' },
  { status: 'Processing', totalQuantity: 11, totalCost: '$38.70' },
  { status: 'Confirmed', totalQuantity: 3, totalCost: '$95.04' },
  { status: 'Confirmed', totalQuantity: 1, totalCost: '$48.45' },
  { status: 'Confirmed', totalQuantity: 14, totalCost: '$116.80' },
  { status: 'Confirmed', totalQuantity: 2, totalCost: '$27.05' },
  { status: 'Complete', totalQuantity: 8, totalCost: '$91.84' },
  { status: 'Confirmed', totalQuantity: 10, totalCost: '$101.87' },
  { status: 'Confirmed', totalQuantity: 2, totalCost: '$52.77' },
  { status: 'Complete', totalQuantity: 5, totalCost: '$89.29' },
  { status: 'Complete', totalQuantity: 6, totalCost: '$44.71' },
  { status: 'Confirmed', totalQuantity: 1, totalCost: '$49.77' },
  { status: 'Confirmed', totalQuantity: 3, totalCost: '$46.07' },
  { status: 'Confirmed', totalQuantity: 15, totalCost: '$39.39' },
  { status: 'Complete', totalQuantity: 9, totalCost: '$39.02' },
  { status: 'Processing', totalQuantity: 13, totalCost: '$40.25' },
  { status: 'Complete', totalQuantity: 2, totalCost: '$39.42' },
  { status: 'Complete', totalQuantity: 8, totalCost: '$68.96' },
  { status: 'Processing', totalQuantity: 4, totalCost: '$94.07' },
  { status: 'Complete', totalQuantity: 15, totalCost: '$38.95' },
  { status: 'Confirmed', totalQuantity: 4, totalCost: '$46.75' },
  { status: 'Complete', totalQuantity: 5, totalCost: '$101.45' },
  { status: 'Processing', totalQuantity: 13, totalCost: '$76.60' },
  { status: 'Processing', totalQuantity: 12, totalCost: '$46.10' },
  { status: 'Complete', totalQuantity: 8, totalCost: '$61.61' },
  { status: 'Confirmed', totalQuantity: 4, totalCost: '$47.77' },
  { status: 'Complete', totalQuantity: 8, totalCost: '$65.39' },
];
